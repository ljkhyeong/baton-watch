...
- 내부 Prometheus 조회를 유지하면서 별도 오버레이를 적용한 경우에만 활성화되는 표준 OTLP 메트릭 내보내기. 인증 헤더는 환경 변수가 아니라 Compose 비밀 파일과 Spring `configtree`로 주입
